...
namespace DoodleJump {
    ...
    double VerticalPlatform::getMMinH() const {
        return m_minH;
    }

    void VerticalPlatform::updateMMinH(double mMinH) {
        m_minH += mMinH;
    }

    double VerticalPlatform::getMMaxH() const {
        return m_maxH;
    }

    void VerticalPlatform::updateMMaxH(double mMaxH) {
        m_maxH += mMaxH;
    }
